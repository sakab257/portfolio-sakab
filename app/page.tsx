    ...
    <div className="w-full flex flex-col items-center">
      <div className="flex w-full items-center justify-center gap-8">
        ...
        <div className="w-fit hidden lg:flex h-fit p-4 gap-8 flex-col">
          <div className="w-full flex gap-8 justify-between mx-auto">
            <CompanyCards />
          </div>
          <div className="w-fit flex flex-col gap-2 justify-between mx-auto">
            <ButtonStyled href="/project" color="#E24430" text="Mes projets"/>
            <ButtonStyled href="/cv.pdf" target="_blank" color="#FFD7BF" text="Telecharger mon cv"/>
          </div>
        </div>
      </div>
